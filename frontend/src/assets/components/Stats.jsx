          ...
          >
            ...
            >
              ...
              <div className="absolute top-4 left-4 z-10">
                <div className="bg-orange-500 w-12 h-12 rounded-lg flex items-center justify-center shadow-lg">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-8 h-8 fill-white">
                    <path d="M12.001 0C5.372 0 0 5.373 0 12.001c0 5.319 3.452 9.81 8.205 11.382.6.11.82-.26.82-.577v-2.165c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.085 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.491.997.108-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0112 6.894c1.02.004 2.047.139 3.006.404 2.29-1.552 3.294-1.23 3.294-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.218.694.824.576 4.752-1.575 8.2-6.065 8.2-11.385C24.002 5.373 18.63 0 12.001 0z"/>
                  </svg>
                </div>
              </div>
